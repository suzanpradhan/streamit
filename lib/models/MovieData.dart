...
class Season {
  ...
  Season({this.description, this.episode, this.image, this.name, this.position, this.year, this.restrict_user_status, this.restriction_setting, this.restrict_subscription_plan});
  ...
  factory Season.fromJson(Map<String, dynamic> json) {
    return Season(
      ...
      restrict_subscription_plan: json['restrict_subscription_plan'] != null ? (json['restrict_subscription_plan'] as List).map((e) => RestrictSubscriptionPlan.fromJson(e)).toList() : null,
    );
  }
